...
struct UABP_VMP_TOR_F_HAIR_04_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_TOR_F_HAIR_04.ABP_VMP_TOR_F_HAIR_04_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_TOR_F_HAIR_04(int32_t EntryPoint); // Function ABP_VMP_TOR_F_HAIR_04.ABP_VMP_TOR_F_HAIR_04_C.ExecuteUbergraph_ABP_VMP_TOR_F_HAIR_04 // (Final|UbergraphFunction) // @ game+0x16c0340
};
