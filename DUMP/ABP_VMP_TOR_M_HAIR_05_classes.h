...
struct UABP_VMP_TOR_M_HAIR_05_C : UAnimInstance {
	...
	struct FAnimNode_AnimDynamics AnimGraphNode_AnimDynamics; // 0x2950(0x440)
	struct FAnimNode_Root AnimGraphNode_Root; // 0x2d90(0x30)

	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_TOR_M_HAIR_05.ABP_VMP_TOR_M_HAIR_05_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_TOR_M_HAIR_05(int32_t EntryPoint); // Function ABP_VMP_TOR_M_HAIR_05.ABP_VMP_TOR_M_HAIR_05_C.ExecuteUbergraph_ABP_VMP_TOR_M_HAIR_05 // (Final|UbergraphFunction) // @ game+0x16c0340
};
