...
struct ABP_ElysiumCandle_02_C : AActor {
	...
	float Random from world(int32_t NewParam); // Function BP_ElysiumCandle_02.BP_ElysiumCandle_02_C.Random from world // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void UserConstructionScript(); // Function BP_ElysiumCandle_02.BP_ElysiumCandle_02_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
};
