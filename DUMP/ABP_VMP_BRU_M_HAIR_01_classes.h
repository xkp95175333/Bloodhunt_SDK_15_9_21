...
struct UABP_VMP_BRU_M_HAIR_01_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_BRU_M_HAIR_01.ABP_VMP_BRU_M_HAIR_01_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_BRU_M_HAIR_01(int32_t EntryPoint); // Function ABP_VMP_BRU_M_HAIR_01.ABP_VMP_BRU_M_HAIR_01_C.ExecuteUbergraph_ABP_VMP_BRU_M_HAIR_01 // (Final|UbergraphFunction) // @ game+0x16c0340
};
