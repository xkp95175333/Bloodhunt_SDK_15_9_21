...
struct UABP_VMP_NOS_F_HAIR_02_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_NOS_F_HAIR_02.ABP_VMP_NOS_F_HAIR_02_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_NOS_F_HAIR_02(int32_t EntryPoint); // Function ABP_VMP_NOS_F_HAIR_02.ABP_VMP_NOS_F_HAIR_02_C.ExecuteUbergraph_ABP_VMP_NOS_F_HAIR_02 // (Final|UbergraphFunction) // @ game+0x16c0340
};
