...
struct UABP_VMP_VEN_F_HAIR_13_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_VEN_F_HAIR_14.ABP_VMP_VEN_F_HAIR_13_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_VEN_F_HAIR_14(int32_t EntryPoint); // Function ABP_VMP_VEN_F_HAIR_14.ABP_VMP_VEN_F_HAIR_13_C.ExecuteUbergraph_ABP_VMP_VEN_F_HAIR_14 // (Final|UbergraphFunction) // @ game+0x16c0340
};
