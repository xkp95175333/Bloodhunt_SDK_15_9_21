...
struct UABP_VMP_NOS_M_HAIR_03_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_NOS_M_HAIR_03.ABP_VMP_NOS_M_HAIR_03_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_NOS_M_HAIR_03(int32_t EntryPoint); // Function ABP_VMP_NOS_M_HAIR_03.ABP_VMP_NOS_M_HAIR_03_C.ExecuteUbergraph_ABP_VMP_NOS_M_HAIR_03 // (Final|UbergraphFunction) // @ game+0x16c0340
};
