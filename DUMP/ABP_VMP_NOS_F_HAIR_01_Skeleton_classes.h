...
struct UABP_VMP_NOS_F_HAIR_01_Skeleton_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_VMP_NOS_F_HAIR_01_Skeleton.ABP_VMP_NOS_F_HAIR_01_Skeleton_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16c0340
	void ExecuteUbergraph_ABP_VMP_NOS_F_HAIR_01_Skeleton(int32_t EntryPoint); // Function ABP_VMP_NOS_F_HAIR_01_Skeleton.ABP_VMP_NOS_F_HAIR_01_Skeleton_C.ExecuteUbergraph_ABP_VMP_NOS_F_HAIR_01_Skeleton // (Final|UbergraphFunction) // @ game+0x16c0340
};
